...
func (a *App) initGRPCServer(ctx context.Context) error {
	...
	desc.RegisterCartServiceServer(a.grpcServer, a.serviceProvider.CartImpl(ctx))
...
func (a *App) initHTTPServer(ctx context.Context) error {
	...
	err := desc.RegisterCartServiceHandlerFromEndpoint(ctx, mux, a.serviceProvider.GRPCConfig().Address(), opts)
	if err != nil {
		return err
	}
